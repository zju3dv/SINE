...
def define_G(
    model_receipt="lightweight_v0",
    init_type="normal",
    init_gain=0.02,
    initialize_weights=True,
    num_input_channels=3,
):
    if model_receipt == "default":
        # default param
        net = skip(num_input_channels=num_input_channels)
    elif model_receipt == "lightweight_v0":
        net = skip(
    ...
    elif model_receipt == "lightweight_v1":
        net = skip(
            num_input_channels=num_input_channels,
            num_output_channels=3,
    ...
    elif model_receipt == "lightweight_single_8":
        net = skip(
            num_input_channels=num_input_channels,
            num_output_channels=3,
            num_channels_down=[8],
